...
import { icpaTheme, tabs } from "../constants/";
      ...
      <Block flex style={styles.group}>
        ...
        <Block style={{ paddingHorizontal: theme.SIZES.BASE }}>
          <Input
            ...
            style={{
              borderColor: icpaTheme.COLORS.INFO,
              borderRadius: 4,
              backgroundColor: "#fff"
            }}
            iconContent={<Block />}
            ...
            iconContent={
              <Block
                ...
                style={{
                  ...
                  height: 20,
                  borderRadius: 10,
                  backgroundColor: icpaTheme.COLORS.INPUT_SUCCESS
                }}
              >
                <Icon
                  size={11}
            ...
            iconContent={
              <Block
                ...
                style={{
                  ...
                  height: 20,
                  borderRadius: 10,
                  backgroundColor: icpaTheme.COLORS.INPUT_ERROR
                }}
              >
                <Icon
                  size={11}
    ...
    return (
      <Block flex style={styles.group}>
        ...
        <Block>
          ...
          <Block style={{ marginBottom: theme.SIZES.BASE }}>
            <Header white back title="Title" navigation={this.props.navigation} bgColor={icpaTheme.COLORS.ACTIVE} titleColor="white" iconColor="white" />
          </Block>
...
const styles = StyleSheet.create({
  ...
  inputDefault: {
    borderBottomColor: icpaTheme.COLORS.PLACEHOLDER
  },
  inputTheme: {
    borderBottomColor: icpaTheme.COLORS.PRIMARY
  },
  inputTheme: {
    borderBottomColor: icpaTheme.COLORS.PRIMARY
  },
  inputInfo: {
    borderBottomColor: icpaTheme.COLORS.INFO
  },
  inputSuccess: {
    borderBottomColor: icpaTheme.COLORS.SUCCESS
  },
  inputWarning: {
    borderBottomColor: icpaTheme.COLORS.WARNING
  },
  inputDanger: {
    borderBottomColor: icpaTheme.COLORS.ERROR
  },
  social: {
